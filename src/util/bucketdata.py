...
class BucketData(object):
    ...
    def append(self, datum, label, label_plain, comment, path):
    ...
    def flush_out(self, bucket_specs, valid_target_length=float('inf'),
        ...
        self.data_list, self.label_list, self.label_list_plain, self.comment_list, self.path_lis = [], [], [], [], []
    ...
    def __add__(self, other):
        ...
        res.path_list = self.path_list + other.path_list
        return res
