...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_width', type=int, default=160,
                        help='Max image width')
    parser.add_argument('--max_height', type=int, default=60,
                        help='Max image height')
    parser.add_argument('--max_prediction', type=int, default=8,
